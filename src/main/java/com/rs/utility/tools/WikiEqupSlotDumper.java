...
import com.rs.utility.tools.WikiEqupSlotDumper.EquipSlot.SlotType;
...
public class WikiEqupSlotDumper {
	...
	private static EquipSlot getEquipSlot(Item item, String line) {
		...
		/*	if (Equipment.isFullHat(item))
				new EquipSlot(id, SlotType.FULL_HELMET);
			else if (Equipment.isFullMask(item))
