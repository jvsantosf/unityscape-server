...
public class HintIconsManager {
	...
	public int addHintIcon(Position tile, int distanceFromFloor, int direction, int arrowType, int modelId, boolean saveIcon) {
		return addHintIcon(tile.getX(), tile.getY(), tile.getZ(), distanceFromFloor, direction, arrowType, modelId, saveIcon);
	}
