...
public final class QueenBlackDragon extends NPC {
	 ...
	 */
	public QueenBlackDragon(Player attacker, Position tile, Position base) {
		super(15509, tile, -1, 0, true, true);
	...
	public void spawnWorm() {
		...
		final Position destination = base.transform(28 + Utils.random(12), 28 + Utils.random(6), 0);
			...
			public void run() {
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						NPC worm = new NPC(15464, destination, -1, 0, true, true);
						worms.add(worm);
