...
import com.rs.game.world.entity.player.cutscenes.actions.NPCAnimationAction;
...
import com.rs.game.world.entity.player.cutscenes.actions.NPCGraphicAction;
...
import com.rs.game.world.entity.player.cutscenes.actions.PlayerGraphicAction;
import com.rs.game.world.entity.player.cutscenes.actions.PlayerMusicEffectAction;
...
public class HomeCutScene extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		actionsList.add(new CreateNPCAction(GUTHIX, 945, 10, 6, 0, -1));
		...
		actionsList.add(new MovePlayerAction(14, 38, 0, Player.TELE_MOVE_TYPE,
				0));
		actionsList.add(new LookCameraAction(14, 20, 3000, 3));
		actionsList.add(new PosCameraAction(14, 5, 5000, 15));
