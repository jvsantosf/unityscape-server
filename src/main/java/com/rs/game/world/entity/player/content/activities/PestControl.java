...
import com.rs.game.world.entity.npc.pest.PestMonsters;
import com.rs.game.world.entity.npc.pest.PestPortal;
import com.rs.game.world.entity.npc.pest.Shifter;
import com.rs.game.world.entity.npc.pest.Spinner;
import com.rs.game.world.entity.npc.pest.Splatter;
...
public class PestControl {
	...
	if (pestCounts[index] >= (index == 4 ? 4 : (portals[index] != null && portals[index].isLocked()) ? 5 : 15))
	    return false;
	pestCounts[index]++;
	Position baseTile = getWorldTile(SPAWN_LOCATIONS[0][index], SPAWN_LOCATIONS[1][index]);
