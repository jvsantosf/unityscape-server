...
public class Wyrm extends CombatScript {
    ...
    private static final Projectile MAGIC = new Projectile( 1554, 24, 36, 40, 16, 30, 1);
    private static final Projectile SPECIAL = new Projectile( 1554, 24, 36, 40, 16, 30, 1);

    @Override
    public Object[] getKeys() {
        return new Object[] {16156};
    }
    ...
    private void magic_attack(NPC npc, Entity target, int max_hit) {
        npc.animate(new Animation(28270));
