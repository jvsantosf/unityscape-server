...
public class DungeoneeringMining extends MiningBase {
	...
	private int getMiningDelay(Player player) {
		int mineTimer = definitions.getOreBaseTime() - player.getSkills().getLevel(Skills.MINING) - com.rs.utility.Utils.getRandom(axeDefinitions.getPickAxeTime());
		if (mineTimer < 1 + definitions.getOreRandomTime())
			mineTimer = 1 + com.rs.utility.Utils.getRandom(definitions.getOreRandomTime());
	...
	public int processWithDelay(Player player) {
		...
		if (com.rs.utility.Utils.random(5) == 0) {
			...
			World.spawnObject(new WorldObject(rock.getId() + 1, rock.getType(), rock.getRotation(), rock.getX(), rock.getY(), rock.getZ()));
