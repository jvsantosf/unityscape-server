...
public class HolyDrake extends CombatScript {

    private static final Projectile MAGIC = new Projectile( 6636, 24, 36, 40, 16, 30, 1);
    private static final Projectile SPECIAL = new Projectile( 6636, 24, 36, 40, 16, 30, 1);

    @Override
    public Object[] getKeys() {
        return new Object[] {16120};
    }
    ...
    private void magic_attack(NPC npc, Entity target, int max_hit) {
        npc.animate(new Animation(28276));
