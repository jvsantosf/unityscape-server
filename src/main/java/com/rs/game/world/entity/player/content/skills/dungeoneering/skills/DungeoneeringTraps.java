...
import com.rs.game.world.entity.npc.dungeonnering.MastyxTrap;
...
public class DungeoneeringTraps {
	...
	public static void skinMastyx(Player player, NPC npc) {
		player.animate(new Animation(827));
		player.getInventory().addItemDrop(MASTRYX_HIDES[getNPCTier(npc.getId() - 10)], com.rs.utility.Utils.random(2, 5));
		npc.finish();
	}
