...
import com.rs.game.world.entity.npc.others.AnimatedArmor;
...
public class WarriorsGuild extends Controller {
     ...
     */
    private static final Position[] DUMMY_LOCATIONS = { new Position(2860, 3549, 0), new Position(2860, 3547, 0), new Position(2859, 3545, 0), new Position(2857, 3545, 0), new Position(2855, 3546, 0), new Position(2855, 3548, 0), new Position(2856, 3550, 0), new Position(2858, 3550, 0) };
    private static final int[] DUMMY_ROTATIONS = { 1, 1, 2, 2, 3, 3, 0, 0 };

    /**
     * Catapult Activity (Defence)
     */
    private static final Position CATAPULT_TARGET = new Position(2842, 3541, 1);
    private static final NPC CATAPULT_PROJECTILE_BASE = new NPC(1957, new Position(2842, 3550, 1), -1, false);
     ...
     */
    private static final Position SHOTPUT_FACE_18LB = new Position(2876, 3549, 1),
	    SHOTPUT_FACE_22LB = new Position(2876, 3543, 1);

    /**
     * Cylopes Activity
     */
    private static final int[] DEFENDERS = { 20072, 8850, 8849, 8848, 8847, 8846, 8845, 8844 };
    public static final Position CYCLOPS_LOBBY = new Position(2843, 3535, 2);
	...
	if (object.getId() >= 15624 && object.getId() <= 15630) {
		...
		return false;
	    player.lock(2);
	    WorldObject opened = new WorldObject(object.getId(), object.getType(), object.getRotation() - 1, object.getX(), object.getY(), object.getZ());
	    ...
	    return false;
	} else if (object.getId() == 15658 || object.getId() == 15660 || object.getId() == 15653 || object.getId() == 66758 && object.getX() == 2861 && object.getY() == 3538 && object.getZ() == 1) {
	    if (World.isSpawnedObject(object))
		return false;
	    ...
	    player.setNextFacePosition(CYCLOPS_LOBBY);
	...
	return player.withinArea(2837, 3538, 2847, 3552) && player.getZ() == 1;
    }
	...
	player.lock(7);
	player.setNextFacePosition(is18LB ? SHOTPUT_FACE_18LB : SHOTPUT_FACE_22LB);
	if (stage == 0 || stage == 2)
	...
	WorldTasksManager.schedule(new WorldTask() {
		...
		if (ticks == 3) {
		    Position tile = new Position(player.getX() + distance, player.getY(), 1);
