...
import com.rs.game.world.entity.player.content.skills.dungeoneering.rooms.HandledRoom;
...
public final class DungeonUtils {
	...
	public static int getSafeMusic(int type) {
		return DungeonConstants.SAFE_MUSICS[type][com.rs.utility.Utils.random(DungeonConstants.DANGEROUS_MUSICS[type].length)];
	}

	public static int getDangerousMusic(int type) {
		return DungeonConstants.DANGEROUS_MUSICS[type][com.rs.utility.Utils.random(DungeonConstants.DANGEROUS_MUSICS[type].length)];
	}

	public static RoomReference getRandomRoom(Room[][] map) {
		return new RoomReference(com.rs.utility.Utils.random(map.length), com.rs.utility.Utils.random(map[0].length));
	}

	public static int getGuardianCreature(int type) {
		return DungeonConstants.GUARDIAN_CREATURES[type + 1][com.rs.utility.Utils.random(DungeonConstants.GUARDIAN_CREATURES[type + 1].length)];
	}

	public static int getGuardianCreature() {
		return DungeonConstants.GUARDIAN_CREATURES[0][com.rs.utility.Utils.random(DungeonConstants.GUARDIAN_CREATURES[0].length)];
	}

	public static int getForgottenWarrior() {
		int type = com.rs.utility.Utils.random(DungeonConstants.FORGOTTEN_WARRIORS.length);
		return DungeonConstants.FORGOTTEN_WARRIORS[type][com.rs.utility.Utils.random(type)];
	}

	public static int getHunterCreature() {
		return DungeonConstants.HUNTER_CREATURES[com.rs.utility.Utils.random(DungeonConstants.HUNTER_CREATURES.length)];
	}

	public static int getSlayerCreature() {
		return DungeonConstants.SLAYER_CREATURES[com.rs.utility.Utils.random(DungeonConstants.SLAYER_CREATURES.length)];
	}
	...
	public static int getRandomGear(int tier) {
		switch (com.rs.utility.Utils.random(29)) {
			case 0:
	...
	public static int getRandomRangeGear(int tier) {
		switch (com.rs.utility.Utils.random(7)) {
			case 0:
				return getLongbow(tier);
			case 1:
				return getShortbow(tier);
	...
	public static int getRandomMeleeGear(int tier) {
		switch (com.rs.utility.Utils.random(15)) {
			case 0:
				return getKiteshield(tier);
			case 1:
				return getPlatebody(tier);
	...
	public static int getRandomWeapon(int tier) {
		switch (com.rs.utility.Utils.random(12)) {
			case 0:
				return getLongbow(tier);
			case 1:
				return getShortbow(tier);
	...
	public static boolean isOpenSkillDoor(int id, int type) {
		for (DungeonConstants.SkillDoors s : DungeonConstants.SkillDoors.values()) {
