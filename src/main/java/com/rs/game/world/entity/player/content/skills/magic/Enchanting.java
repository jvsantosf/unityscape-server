...
public class Enchanting {
	...
	private static short[][] JEWLERY_NODES = { { 1694, 1637, 1658, 11072 }, { 1639, 1658, 1696, 11076 },
			{ 1641, 1660, 1698, 11086 }, { 1643, 1662, 1700, 11092 }, { 1645, 1664, 1702, 11115 },
			{ 6575, 6581, 11128, 11130, 29145, 29147, 29149, 29151 } };
	
	private static short[][] JEWLERY_PRODUCT = { { 1727, 2550, 3853, 11074 }, { 2552, 12622, 1729, 11079 },
			{ 2568, 11194, 1725, 11088 }, { 2570, 11090, 1731, 11095 }, { 2572, 11105, 1712, 11118 },
			{ 6583, 6585, 6579, 11133, 29153, 29155, 29157, 29159 } };
	
	private static int[][] JEWLERY_RUNES = { { 564, 1, 555, 1 }, { 564, 1, 556, 1 }, { 564, 1, 554, 5 },
			{ 564, 1, 557, 10 }, { 557, 15, 555, 15 }, { 557, 20, 554, 20 }, };
	...
	private static int[][] BOLT_RUNES = { { 564, 1, 556, 2 }, { 564, 1, 555, 1, 558, 1 }, { 564, 1, 557, 2 },
			{ 564, 1, 555, 2 }, { 564, 1, 556, 3, 561, 1 }, { 564, 1, 554, 2 }, { 564, 1, 554, 5, 565, 1 },
			{ 564, 1, 557, 10, 563, 2 }, { 564, 1, 557, 15, 566, 1 }, { 564, 1, 554, 20, 560, 1 } };
	...
	public static void processMagicEnchantSpell(Player player, int slot, int primaryIndex) {
		...
		if (secondaryIndex == -1) {
			...
			return;
		player.lock(3);
		player.animate(new Animation(JEWLERY_ANIMATIONS[primaryIndex]));
	...
	public static void processBoltEnchantSpell(Player player, final int index, final int ticks) {
		...
		player.getActionManager().setAction(new Action() {
			...
			public int processWithDelay(Player player) {
				...
				player.animate(new Animation(4462));
