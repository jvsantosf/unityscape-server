...
public enum AreaType {
	 ...
	 */
	CLASSIC_AREA(new Position(2752, 5888, 0), new Position(2815, 6015, 0), 35, 10, -36, -9, 56, 58, -7, -58),
	
	/**
	 * The plateau area type.
	 */
	PLATEAU(new Position(2831, 5888, 0), new Position(2928, 5951, 0), 59, 12, -38, -10, 27, 21, -70, -20),
	
	/**
	 * The forsaken quarry area type.
	 */
	FORSAKEN_QUARRY(new Position(2880, 5504, 0), new Position(2943, 5567, 0), 11, 11, -10, -10, 28, 32, -28, -30),
	
	/**
	 * The blasted forest area type.
	 */
	BLASTED_FOREST(new Position(2880, 5632, 0), new Position(2942, 5695, 0), 12, 9, -12, -9, 13, 29, -13, -28),
	
	/**
	 * The turrets area type.
	 */
	TURRETS(new Position(2689, 5505, 0), new Position(2750, 5630, 0), 42, 7, -40, -5, 2, 3, 0, -1);
	 ...
	 */
	private AreaType(Position southWestTile, Position northEastTile, int firstSpawnOffsetX, int firstSpawnOffsetY, int secondSpawnOffsetX, int secondSpawnOffsetY, int firstDeathOffsetX, int firstDeathOffsetY, int secondDeathOffsetX, int secondDeathOffsetY) {
