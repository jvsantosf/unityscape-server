...
public class SwampKraken extends CombatScript {

    private static final Projectile MAGIC = new Projectile( 2705, 24, 36, 40, 16, 30, 1);
    private static final Projectile SPECIAL = new Projectile( 2707, 24, 36, 40, 16, 30, 1);

    @Override
    public Object[] getKeys() {
        return new Object[] {16117};
    }
