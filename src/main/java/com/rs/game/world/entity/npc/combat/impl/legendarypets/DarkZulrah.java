...
public class DarkZulrah extends CombatScript {

    private static final Projectile MAGIC = new Projectile( 195, 24, 36, 40, 16, 30, 1);
    private static final Projectile SPECIAL = new Projectile( 195, 24, 36, 40, 16, 30, 1);

    @Override
    public Object[] getKeys() {
        return new Object[] {16122};
    }
    ...
    private void magic_attack(NPC npc, Entity target, int max_hit) {
        npc.animate(new Animation(22407));
