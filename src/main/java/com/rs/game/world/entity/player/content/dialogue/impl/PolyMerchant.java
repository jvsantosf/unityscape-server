 ...
 * @author Vichy
 */
public class PolyMerchant extends Dialogue {
    ...
    public void run(int interfaceId, int componentId) {
    	...
    	case 2:
    		switch (componentId) {
    		case OPTION_1:
    			sendPlayerDialogue(QUESTION, "Who are you?");
    			stage = 3;
    			break;
    		case OPTION_2:
    			sendPlayerDialogue(QUESTION, "What is this place?");
    			stage = 12;
    			break;
    		case OPTION_3:
    			sendPlayerDialogue(QUESTION, "Tell me about the things you sell.");
    			stage = 17;
    			break;
    		case OPTION_4:
    			sendPlayerDialogue(QUESTION, "Can I buy your costume?");
    			stage = 24;
    			break;
    		case OPTION_5:
