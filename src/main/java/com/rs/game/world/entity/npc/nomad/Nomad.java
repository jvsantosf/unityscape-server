...
public class Nomad extends NPC {
	...
	private Position throneTile;
	private ArrayList<NPC> copies;
	private boolean healed;
	private int notAttacked;
	private Player target;
	
	public Nomad(int id, Position tile, int mapAreaNameHash,
	...
	public void sendTeleport(final Position tile) {
	...
	public Position getThroneTile() {
		/*
		 * if no throne returns middle of area
		 */
		return throneTile == null ? new Position((getRegionX() << 6) + 32, (getRegionY() << 6) + 32, getZ()) : throneTile;
	}

	public void setThroneTile(Position throneTile) {
	...
	public Position getCopySpot(int index) {
		Position throneTile = getThroneTile();
		switch(index) {
		case 0:
			return throneTile;
		case 1:
