...
public final class QueenBlackDragonController extends Controller {
	...
	public static final Position OUTSIDE = Constants.HOME_PLAYER_LOCATION1;
				...
				try {
					...
					FadingScreen.unfade(player, time, new Runnable() {
						...
						public void run() {
							...
							player.setNextPosition(base.transform(33, 28, 0));
	...
	public boolean processObjectClick1(WorldObject object) {
		...
		if (object.getId() == 70790) {
			...
			FadingScreen.fade(player, new Runnable() {
				...
				public void run() {
					...
					player.setNextPosition(base.transform(31, 36, -1));
		...
		if (object.getId() == 70813) {
			Magic.sendObjectTeleportSpell(player, true, Constants.HOME_PLAYER_LOCATION1);
			return false;
		}
