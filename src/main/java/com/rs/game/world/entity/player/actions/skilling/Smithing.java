...
public class Smithing extends Action {
	...
	public enum ForgingBar {
		...
		ADAMANT(2361, 70, new Item[] { new Item(1211, 1), new Item(1357, 1),
				new Item(1430, 1), new Item(1145, 1), new Item(9380, 10),
				new Item(1287, 1), new Item(823, 10), new Item(4823, 15),
				new Item(-1, 1), new Item(-1, 1), new Item(-1, 1),
				new Item(43, 15), new Item(1331, 1), new Item(9429, 1),
				new Item(1301, 1), new Item(867, 5), new Item(1161, 1),
				...
				BRONZE(2349, 0, new Item[] { new Item(1205, 1), new Item(1351, 1),
						new Item(1422, 1), new Item(1139, 1), new Item(9375, 10),
						new Item(1277, 1), new Item(819, 10), new Item(4819, 15),
						new Item(1794, 1), new Item(-1, 1), new Item(-1, 1),
						new Item(39, 15), new Item(1321, 1), new Item(9420, 1),
						new Item(1291, 1), new Item(864, 5), new Item(1155, 1),
						...
						IRON(2351, 15, new Item[] { new Item(1203, 1), new Item(1349, 1),
								new Item(1420, 1), new Item(1137, 1), new Item(9377, 10),
								new Item(1279, 1), new Item(820, 10), new Item(4820, 15),
								new Item(-1, 1), new Item(7225, 1), new Item(-1, 1),
								new Item(40, 15), new Item(1323, 1), new Item(9423, 1),
								new Item(1293, 1), new Item(863, 5), new Item(1153, 1),
								...
								MITHRIL(2359, 50, new Item[] { new Item(1209, 1), new Item(1355, 1),
										new Item(1428, 1), new Item(1143, 1), new Item(9379, 10),
										new Item(1285, 1), new Item(822, 10), new Item(4822, 15),
										new Item(-1, 1), new Item(-1, 1), new Item(-1, 1),
										new Item(42, 15), new Item(1329, 1), new Item(9427, 1),
										new Item(1299, 1), new Item(866, 5), new Item(1159, 1),
										...
										RUNE(2363, 85, new Item[] { new Item(1213, 1), new Item(1359, 1),
												new Item(1432, 1), new Item(1147, 1), new Item(9381, 10),
												new Item(1289, 1), new Item(824, 10), new Item(4824, 15),
												new Item(-1, 1), new Item(-1, 1), new Item(-1, 1),
												new Item(44, 15), new Item(1333, 1), new Item(9431, 1),
												new Item(1303, 1), new Item(868, 5), new Item(1163, 1),
												...
												STEEL(2353, 30, new Item[] { new Item(1207, 1), new Item(1353, 1),
														new Item(1424, 1), new Item(1141, 1), new Item(9378, 10),
														new Item(1281, 1), new Item(821, 10), new Item(1539, 15),
														new Item(-1, 1), new Item(-1, 1), new Item(2370, 1),
														new Item(41, 15), new Item(1325, 1), new Item(9425, 1),
														new Item(1295, 1), new Item(865, 5), new Item(1157, 1),
	...
	public boolean process(Player player) {
		if (!player.getInventory().containsItem(HAMMER, 1) && !player.getToolbelt().containsItem(HAMMER)) {
	...
	private double getExperience(Player player) {
		...
		int barAmount = ForgingInterface.getActualAmount(levelRequired, bar,
				bar.getItems()[index].getId());
		return bar.getExperience()[barAmount == 5 ? 3 : barAmount - 1] * (player.getEquipment().wearingSkillCape(Skills.SMITHING) ? 1.10D : 1);
	}
	...
	public static class ForgingInterface {
		...
		public static int getActualAmount(int levelRequired, ForgingBar bar,
			...
			if (level >= 0 && level <= 4) {
				...
				if (name.contains("knife") || name.contains("limb") || name.contains("arrowtip") || name.contains("studs")) {
					return 1;
				}
				return 2;
		...
		public static void sendSmithingInterface(Player player, ForgingBar bar) {
			...
			for (int i = 0; i < bar.getItems().length; i++) {
				player.getPackets().sendItemOnIComponent(SMITHING_INTERFACE,
						componentChilds[i], bar.getItems()[i].getId(),
						bar.getItems()[i].getAmount());
