...
public class ToxicDevil extends CombatScript {

    private static final Projectile MAGIC = new Projectile( 1470, 24, 36, 40, 16, 30, 1);
    private static final Projectile SPECIAL = new Projectile( 1470, 24, 36, 40, 16, 30, 1);

    @Override
    public Object[] getKeys() {
        return new Object[] {16143};
    }
    ...
    private void magic_attack(NPC npc, Entity target, int max_hit) {
        npc.animate(new Animation(7816));
