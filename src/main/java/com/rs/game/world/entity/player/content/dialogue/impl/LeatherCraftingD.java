...
public class LeatherCraftingD extends Dialogue {
    ...
    public static final int[] BASE_LEATHER = { 1741, 1743, 1745, 2505, 2507, 2509, 24374, 22451, 22449, 22450, 28840, };
    public static final double[][] EXPERIENCE = { { 13.8, 16.25, 18.5, 22, 25, 27, 30, 37 }, { 32, 34, 35, 36 }, { 62, 124, 186, 248 }, { 70, 140, 210, 280 }, { 78, 156, 234, 312 }, { 86, 172, 258, 334 }, { 94, 188, 282 }, { 100, 300, 1000 }, { 10, 20, 30 }, { 50, 150, 500 } , { 500, 150, 50 } };
    private int[][] LEVELS = { { 1, 7, 9, 11, 14, 18, 19, 38 }, { 25, 27, 28, 29 }, { 57, 60, 63, 64 }, { 66, 68, 71, 72 }, { 73, 75, 77, 78 }, { 79, 82, 84, 85 }, { 87, 89, 93 }, { 86, 92, 98 }, { 3, 12, 21 }, { 65, 72, 78 }, { 90, 91, 92 } };
    private static final Item[][] POTENTIAL_PRODUCTS = { { new Item(1059, 1), new Item(1061, 1), new Item(1167, 1), new Item(1063, 1), new Item(1129, 1), new Item(1095, 1), new Item(25806, 1), new Item(1169, 1) }, { new Item(25875, 1), new Item(25821, 1), new Item(1131, 1), new Item(25808, 1) }, { new Item(1065, 1), new Item(1099, 2), new Item(1135, 3), new Item(25794, 4) }, { new Item(2487, 1), new Item(2493, 2), new Item(2499, 3), new Item(25796, 4) }, { new Item(2489, 1), new Item(2495, 2), new Item(2501, 3), new Item(25798, 4) }, { new Item(2491, 1), new Item(2497, 2), new Item(2503, 3), new Item(25800, 4) }, { new Item(24376, 1), new Item(24379, 2), new Item(24382, 3) }, { new Item(22482, 500), new Item(22486, 1500), new Item(22490, 5000) }, { new Item(22458, 300), new Item(22462, 1000), new Item(22466, 2500) }, { new Item(22470, 400), new Item(22474, 1200), new Item(22478, 3500),}, {new Item(28847, 3), new Item(28845, 2) , new Item(28843, 1) } };
    private static final Item[][] REQUIRED_BASE_ITEMS = { null, null, null, null, null, null, null, new Item[] { new Item(22452, 1), new Item(22454, 1), new Item(22456, 1) }, new Item[] { new Item(22452, 1), new Item(22454, 1), new Item(22456, 1) }, new Item[] { new Item(22452, 1), new Item(22454, 1), new Item(22456, 1), }, null, null, null };
