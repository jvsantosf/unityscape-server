...
public class NewProjectile {
	...
	public NewProjectile(Position from, Position to, int graphicsId, int startHeight, int endHeight, int delay, int slope, int speed, int distanceOffset) {
		this.from = from;
		this.to = to;
	...
	public NewProjectile(Position from, Position to, int graphicsId, int startHeight, int endHeight, int speed, int delay) {
		this.from = from;
		this.to = to;
		this.graphicsId = graphicsId;
		this.startHeight = startHeight;
	...
	public NewProjectile(Position from, Position to, int graphicsId, int startHeight, int endHeight, int delay) {
		this.from = from;
		this.to = to;
		this.graphicsId = graphicsId;
		this.startHeight = startHeight;
	...
	public NewProjectile(Position from, Position to, int graphicsId, int startHeight, int endHeight) {
		this.from = from;
		this.to = to;
		this.graphicsId = graphicsId;
		this.startHeight = startHeight;
