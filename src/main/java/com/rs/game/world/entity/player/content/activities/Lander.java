...
import com.rs.game.world.entity.player.content.activities.PestControl.PestData;

public class Lander {

    public static Lander[] landers = new Lander[3];
    private static final int AUTO_GAME = Constants.DEBUG ? 15 : 15;
	...
	NOVICE(0, 40, new Position(2661, 2639, 0), new Position(2657, 2639, 0)),

	INTERMEDIATE(1, 70, new Position(2641, 2644, 0), new Position(2644, 2644, 0)),

	VETERAN(2, 100, new Position(2635, 2653, 0), new Position(2638, 2653, 0));
	...
	private LanderRequirement(int id, int requirement, Position tile, Position exit) {
	    this.id = id;
