...
public class OlmletCombat extends CombatScript {

    private static final Projectile MAGIC = new Projectile(Graphics.createOSRS(1339).getId(), 24, 36, 40, 16, 30, 1);
    private static final Projectile SPECIAL = new Projectile(Graphics.createOSRS(1339).getId(), 24, 36, 40, 16, 30, 1);

    @Override
    public Object[] getKeys() {
        return new Object[] {27519, 16115};
    }
    ...
    private void magic_attack(NPC npc, Entity target, int max_hit) {
        npc.animate(new Animation(27398));
