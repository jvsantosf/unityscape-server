...
public class QuestManager {
	 ...
	 */
	private ArrayList<Quest> quests = new ArrayList<Quest>(Constants.QUESTS);
	...
	private static class Quests {
		 ...
		 */
		private static final Map<Object, Class<Quest>> quests = new HashMap<Object, Class<Quest>>(Constants.QUESTS);
