 ...
 */
	 ...
	 * return seconds
	 */
	public int getActivationTime(int aura) {
		double bonus = 1;
		...
		switch (aura) {
		case 20958:
			return (int) (600 * bonus); // 10minutes
		case 22268:
			return (int) (1200 * bonus); // 20minutes
		case 22302:
			return (int) (1800 * bonus); // 30minutes
		case 22294:
			return (int) (7200 * bonus); // 2hours
		case 20959:
			return (int) (10800 * bonus); // 3hours
		default:
			return (int) (3600 * bonus); // default 1hour
		}
	}
