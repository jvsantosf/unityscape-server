...
import com.rs.game.world.entity.npc.fightkiln.FightKilnNPC;
import com.rs.game.world.entity.npc.fightkiln.HarAken;
import com.rs.game.world.entity.npc.fightkiln.TokHaarKetDill;
...
public class FightKiln extends Controller {
	...
	public static final Position OUTSIDE = new Position(4744, 5172, 0);
				...
				CoresManager.slowExecutor.execute(new Runnable() {
					...
					public void run() {
						...
						if(currentWave == 0) { //SCENE 0
							...
							player.setNextPosition(getWorldTile(31, 51));
							tokHaarHok = new NPC(TOKHAAR_HOK, getWorldTile(30, 36), -1, 0, true, true);
							...
							player.setNextPosition(getWorldTile(38, 25));
							player.setNextFacePosition(getWorldTile(38, 26));
							tokHaarHok = new NPC(TOKHAAR_HOK_SCENE, getWorldTile(37, 30), -1, 0, true, true);
							tokHaarHok.setDirection(Utils.getFaceDirection(0, -1));
							...
							WorldTasksManager.schedule(new WorldTask()  {
								...
								@Override
								public void run() {
									Position lookTo = getWorldTile(40, 28);
									player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
											Cutscene.getY(player, lookTo.getY()), 2200);
									Position posTile = getWorldTile(29, 28);
									player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
							...
							WorldTasksManager.schedule(new WorldTask()  {
								...
								public void run() {
									if(count == 0) {
										Position lookTo = getWorldTile(32, 41);
										player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
												Cutscene.getY(player, lookTo.getY()), 1000);
										Position posTile = getWorldTile(32, 38);
										player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
												Cutscene.getY(player, posTile.getY()), 1200);
									}else if (count == 6) {
										Position lookTo = getWorldTile(64, 30);
										player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
												Cutscene.getY(player, lookTo.getY()), 3000);
										Position posTile = getWorldTile(42, 36);
										player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
												Cutscene.getY(player, posTile.getY()), 3000);
										player.setNextPosition(getWorldTile(33, 39));
										player.setNextFacePosition(getWorldTile(32, 39));
									}else if (count == 12) {
										stop();
										tokHaarHok = new NPC(TOKHAAR_HOK_SCENE, getWorldTile(28, 38), -1, 0, true, true);
										tokHaarHok.setDirection(Utils.getFaceDirection(1, 0));

										Position lookTo = getWorldTile(30, 38);
										player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
												Cutscene.getY(player, lookTo.getY()), 2500);
										Position posTile = getWorldTile(30, 30);
										player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
												Cutscene.getY(player, posTile.getY()), 3000);
							...
							player.setNextPosition(getWorldTile(21, 21));
							player.setNextFacePosition(getWorldTile(20, 20));
							player.getPackets().sendBlackOut(2);
							player.getPackets().sendConfig(1241, 1);
							WorldTasksManager.schedule(new WorldTask()  {
								...
								@Override
								public void run() {
									Position lookTo = getWorldTile(20, 17);
									player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
											Cutscene.getY(player, lookTo.getY()), 2500);
									Position posTile = getWorldTile(25, 26);
									player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
											Cutscene.getY(player, posTile.getY()), 3000);
							...
							tokHaarHok = new NPC(TOKHAAR_HOK_SCENE, getWorldTile(30, 43), -1, 0, true, true);
							tokHaarHok.setDirection(Utils.getFaceDirection(0, -1));
							teleportPlayerToMiddle();
							player.getPackets().sendBlackOut(2);
							player.getPackets().sendConfig(1241, 1);
							WorldTasksManager.schedule(new WorldTask()  {
								...
								@Override
								public void run() {
									Position lookTo = getWorldTile(31, 43);
									player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
											Cutscene.getY(player, lookTo.getY()), 2500);
									Position posTile = getWorldTile(31, 34);
									player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
							...
							tokHaarHok = new NPC(TOKHAAR_HOK_SCENE, getWorldTile(45, 45), -1, 0, true, true);
							...
							WorldTasksManager.schedule(new WorldTask()  {
								...
								@Override
								public void run() {
									Position lookTo = getWorldTile(45, 45);
									player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
											Cutscene.getY(player, lookTo.getY()), 1000);
									Position posTile = getWorldTile(38, 37);
									player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
											Cutscene.getY(player, posTile.getY()), 3000);
							...
							new Item(23657, Integer.MAX_VALUE),
							new Item(23658, Integer.MAX_VALUE));
							tokHaarHok = new NPC(TOKHAAR_HOK_SCENE, getWorldTile(30, 36), -1, 0, true, true);
							tokHaarHok.setDirection(Utils.getFaceDirection(0, 1));
							player.setNextPosition(getWorldTile(31, 39));
							player.getPackets().sendBlackOut(2);
							player.getPackets().sendConfig(1241, 1);
							player.setNextFacePosition(tokHaarHok);
							WorldTasksManager.schedule(new WorldTask()  {

								@Override
								public void run() {
									Position lookTo = getWorldTile(31, 40);
									player.getPackets().sendCameraLook(Cutscene.getX(player, lookTo.getX()),
											Cutscene.getY(player, lookTo.getY()), 1000);
									Position posTile = getWorldTile(31, 50);
									player.getPackets().sendCameraPos(Cutscene.getX(player, posTile.getX()),
											Cutscene.getY(player, posTile.getY()), 3000);
...
42 42 maxX, maxY
	...
	public void startWave() {
		if(stage != Stages.RUNNING)
			return;
		int currentWave = getCurrentWave();
		if (player.getDonationManager().getRank() == DonatorRanks.DRAGON) {
			currentWave = 10;
		}
	...
	public void teleportPlayerToMiddle() {
		player.setNextPosition(getWorldTile(31, 32));
	}
			...
			if(type == 1 || type == 4) {
				...
				if(type == 4) {
					...
					if(!player.getInventory().addItem(itemId, 1)) 
						World.addGroundItem(new Item(itemId, 1), new Position(player), player, true, 180);
					player.reset();
