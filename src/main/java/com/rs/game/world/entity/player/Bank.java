...
import com.rs.game.world.entity.player.content.MoneyPouch;
...
public class Bank implements Serializable {
	...
	public void openPin() {
		...
		if (recoveryDelay >= Utils.currentTimeMillis()) {
			...
			player.getPackets().sendIComponentText(13, 27, "Bank of " + Constants.SERVER_NAME);
	}
	...
	public void openDepositBox() {
		...
		// tab
		sendBoxInterItems();
		player.getPackets().sendIComponentText(11, 13, "Bank Of " + Constants.SERVER_NAME + " - Deposit Box");
		player.setCloseInterfacesEvent(new Runnable() {
			@Override
			public void run() {
