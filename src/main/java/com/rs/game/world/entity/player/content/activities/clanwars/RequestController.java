...
public final class RequestController extends Controller {
	...
	public boolean processObjectClick1(WorldObject object) {
		...
		case 38698: //Safe FFA portal.
			player.setNextPosition(new Position(2815, 5511, 0));
			player.getControlerManager().startControler("clan_wars_ffa", false);
			return false;
		case 38699: //Risk FFA portal.
			player.setNextPosition(new Position(3007, 5511, 0));
	...
	public static boolean inWarRequest(Player player) {
		return (player.inArea(2980, 9664, 3004, 9694) || player.inArea(2591, 2843, 2600, 2847));
	}
}