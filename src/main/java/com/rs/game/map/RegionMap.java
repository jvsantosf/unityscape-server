...
/* old
 * 2097152 cliped tile //0x200000
 * 131072 solid tile //0x20000
 * 262144 floor tile //0x40000
 */
public class RegionMap {
	...
	public void setMask(int plane, int x, int y, int mask) {
		if (x >= 64 || y >= 64 || x < 0 || y < 0) {
			Position tile = new Position(regionX + x, regionY + y, plane);
