...
public enum Direction {
    ...
    NORTH(0, 1, 1024, 0),          //1
    NORTH_EAST(1, 1, 1280, 0),     //2
    WEST(-1, 0, 512, 3),           //3
    EAST(1, 0, 1536, 1),           //4
    SOUTH_WEST(-1, -1, 256, 2),    //5
    SOUTH(0, -1, 0, 2),            //6
    SOUTH_EAST(1, -1, 1792, 2);    //7

    public final int deltaX, deltaY;
    public final int clientValue;
    public final int forceMovementDir;

    Direction(int deltaX, int deltaY, int clientValue, int forceMovementDir) {
        this.deltaX = deltaX;
        this.deltaY = deltaY;
        this.clientValue = clientValue;
        this.forceMovementDir = forceMovementDir;
    }
